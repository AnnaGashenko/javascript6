 ...
 * - в начале уборки уровень энергии должен уменьшиться;
...
function CleanerRobot(
    ...
    // Получаем время уборки
    const getCleaningTime = () => {
        /**
         * Площадь для уборки в метрах / Скорость уборки: 10 квадратных метров в час.
         */
        return cleaningSquare / CLEANING_SPEED
    };
